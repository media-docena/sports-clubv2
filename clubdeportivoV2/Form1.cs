...
namespace clubdeportivoV2
{
    public partial class frmLogin : Form
    {
        ...
        {
            /*
             El siguiente código permite posicionar al panel central que contiene al logo
             y los textboxes de ingreso de usuario al sistema
            */
            pnlCentral.Location = new Point(
                this.ClientSize.Width / 2 - pnlCentral.Size.Width / 2,
                this.ClientSize.Height / 2 - pnlCentral.Size.Height / 2);
            pnlCentral.Anchor = AnchorStyles.None;

            pnlCentral.Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, pnlCentral.Width, pnlCentral.Height, 30, 30));
        }
